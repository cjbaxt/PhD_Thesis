\chapter[Transit timing variations of cool \Kepler~planets from \spitzerIRAC analysis]{Transit timing variations of cool \Kepler~planets from \spitzerIRAC analysis}
...
\begin{figure*}
    ...
    \caption{Corner plot of the posterior distributions resulting from the MCMC fit to the 3.6~$\mu$m \spitzerIRAC lightcurve for Kepler-16b.}
...
\begin{figure*}
    ...
    \caption{Corner plot of the posterior distributions resulting from the MCMC fit to the 4.5~$\mu$m \spitzerIRAC lightcurve for Kepler-16b.}
